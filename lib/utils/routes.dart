...
class AppRoutes {
  ...
  static final pages = [
    ...
    GetPage(name: phoneOtp,     page: () => PhoneOtpScreen(phone: Get.arguments as String? ?? '')),
    GetPage(name: profileSetup, page: () => const ProfileSetupScreen()),
    GetPage(name: home,         page: () => const HomeScreen()),
    GetPage(name: explore,      page: () => ExploreScreen(initialCategory: Get.arguments as String?)),
    GetPage(name: itemDetail,   page: () => ItemDetailScreen(item: Get.arguments as MenuItemModel)),
